...
def get_tweet(doc):
    ...
    # tweet['hashtags'] = map(lambda x: x['tag'],doc['data']['entities']['hashtags'])
    # tweet['hashtags'] = [x['tag'] for x in doc['data']['entities']['hashtags']]
    # tweet['hashtags'] = doc['data']['entities']['hashtags'][0]['tag']
    tweet['coordinates'] = {
        "lat": doc['includes']['places'][0]['geo']['bbox'][1],
        "lon" : doc['includes']['places'][0]['geo']['bbox'][0]
    }
