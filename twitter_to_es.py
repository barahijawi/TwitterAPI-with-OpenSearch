...
import boto3
import config
# from elasticsearch.exceppip install --target ./package requeststions import ElasticsearchException
...
# mapping = {doc_type: tweet_mapping
    ...
    print('hhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhxxxxxxhhhhhhhhhhhhhhhhhhhh')
    for doc in tweets:
        print('222hhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhxxxxxxhhhhhhhhhhhhhhhhhhhh')
        tweet = get_tweet(doc)
        print('3333hhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhxxxxxxhhhhhhhhhhhhhhhhhhhh')
        bulk_doc = {
            "_index": index_name,
            # "_type": 'mappings',
            "_id": tweet[id_field],
        ...
        print('4444hhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhxxxxxxhhhhhhhhhhhhhhhhhhhh')
